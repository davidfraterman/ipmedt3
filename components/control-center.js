...
AFRAME.registerComponent("control-center", {
  ...
  init: function () {
    ...
    const screenPrinterText1 = document.getElementById(
      "js--screen-text-printer-1"
    );
    const screenPrinterText2 = document.getElementById(
      "js--screen-text-printer-2"
    );
    const screenControlCenterText = document.getElementById(
      "js--screen-text-control-center"
    );
    ...
    const deskControlCenterText = document.getElementById(
      "js--desk-control-center-text"
    );
    // scene objects - BUTTONS
    const buttonPrinter1 = document.getElementById(
      "js--desk-printers-button-1"
    );
    const buttonPrinter2 = document.getElementById(
      "js--desk-printers-button-2"
    );
    const buttonControlCenter = document.getElementById(
      "js--desk-control-center-button"
    );
